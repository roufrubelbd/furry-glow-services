...
const Tips = () => {
  return (
    <div className="py-4 my-14 px-2 bg-base-200 space-y-4  w-11/12 mx-auto">
      <h2 className="text-amber-600 text-4xl font-bold">Winter Care Tips for Pets</h2>
      ...
      <h2 className="text-amber-600 text-2xl font-bold">How to Keep Dogs Warm in Winter</h2>
...
It's important to limit your dog’s time outside in winter months and prevent them from getting too cold. Dogs with thin haircoats, like Dachshunds, Greyhounds or Chihuahuas may need to wear a dog winter coat when they go outside.</p>
      <h2 className="text-amber-600 text-2xl font-bold">Winter Cat Care</h2>
      ...
      <h2 className="text-amber-600 text-2xl font-bold">Winter Grooming for Cats and Dogs</h2>
